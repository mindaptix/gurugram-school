    ...
    >
      <div className="mx-auto grid max-w-[1280px] gap-10 lg:grid-cols-[340px_1fr] lg:items-center">
        ...
        <div>
          ...
          <h2 className="mt-5 max-w-[980px] text-[48px] font-black leading-[1.02] tracking-[-0.03em] text-[#111111] max-xl:text-4xl max-md:text-3xl">
            A Legacy of Excellence for Nursery to Class 12
          </h2>

          <p className="mt-6 max-w-[980px] text-[30px] font-medium leading-[1.25] tracking-normal text-[#111111] max-xl:text-3xl max-md:text-2xl">
          ...
          <a
            href="#admissions"
            className="mt-8 inline-flex min-h-[72px] items-center justify-center rounded-full bg-[#08b985] px-10 text-[18px] font-black uppercase tracking-[0.18em] text-white"
          >
            Explore Admissions <span className="ml-2 text-xl leading-none">&#8594;</span>
          </a>
        </div>
      </div>
    </section>
